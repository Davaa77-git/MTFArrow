...
# ============================================================
# 6. Interactive chart (with trade markers)
# ============================================================
...
def plot_chart(final_df, window_size=120, higher_tf='H1', year=2025):
    total = len(final_df)
...
if __name__ == "__main__":
    ...
    # 2. Interactive chart
    plot_chart(df_result, window_size=WINDOW, higher_tf=HTF, year=YEAR)
